...
public class SecondSetActivity extends AppCompatActivity {
    Button squatsButton;
    ...
    public void onBackPressed(){
        RestTimerActivity.boolTimer = false;
        super.onBackPressed();
    }
    ...
    public void workoutDone(View view){
        Intent intent = new Intent(getApplicationContext(), RestTimer2Activity.class);
